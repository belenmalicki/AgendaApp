...
cerrarPop=()=>{
  ...
  mostrarBotonCanc(){
    if(this.props.turno.estado !== 'confirmado'){
      ...
      return <PopUp turno={this.props.turno} update={this.props.forzar} id={this.props.turno.id} key='2' tipo='2' alto='28%' nombre='CANCELAR' col='#e93922' titulo='¿DESEA CANCELAR SU TURNO?' texto='Los turnos podrán ser cancelados hasta 12 Hs. antes del mismo, en caso de no ser así, se le cobrará la penalización correspondiente'/>
    }else{
