...
import { Platform, ScrollView, Text, View, Image, TextInput, Dimensions, TouchableOpacity, ActivityIndicator } from 'react-native';
...
export default class Historial extends Component {
  ...
  renderTurnos() {
    if (!this.state.cargado) {
      ...
      <Text style={{textAlign: 'center', marginTop: '2%', fontSize: 14}}>Todavía no concurriste a ninguna consulta en nuestro Centro Médico.</Text>
      </View>)
    } else {
