  ...
  render() {
    return (
      <ScrollView style={{backgroundColor:'#fbfbfb'}} >
        <Text style={{fontSize:18, textAlign:"center", marginTop: 20, marginBottom:20}}>Acerca de Clinica Arduino</Text>
        ...
        <View>
          ...
          <Text style={{fontSize:14,  marginLeft: 20, marginTop:8}}><Image style={{height:16, width:16}} source={require('../assets/Images/call.png')}/> +54 (011) 5777-3200</Text>
          <Text style={{fontSize:14,  marginLeft: 20, marginTop:8}}><Image style={{height:14, width:14}} source={require('../assets/Images/bus.png')}/><Text style={{fontWeight:'bold'}}>  Lineas de colectivo:</Text> 12 – 39 – 41 – 59 – 60 </Text>
         <View style={{marginTop:8, marginLeft: 20,flexDirection: 'row'}}>
         <Image style={{height:16, width:16}} source={require('../assets/Images/underground.png')}/>
         <Text style={{fontSize:14,   marginHorizontal:7, marginRight:30}}><Text style={{fontWeight:'bold'}}>Lineas de subte:</Text> Línea D: Estación Pueyrredón, Línea H: Estación Santa Fe.</Text>
         </View>
